...
/**
* @brief  User function that is called when 60 ms of PDM data is available.
...
void AudioProcess(void)
{
	 static uint32_t IndexOut = 0;
	  static uint32_t AudioOutActive = 0; //I removed static modifier
...
void BSP_DFSDM_FilterAwdCallback(){
	memset(kws->mfcc_buffer, 0, 250);
